...
MAIL_TEXT = {
    ...
    # 링크가 나라장터로만 가지 않는다. 출처가 '사이트' 인 건은 기관
    # 홈페이지가 열린다. 그래서 '나라장터 공고 화면' 이라고 적지 않는다.
    "안내": ("공고명을 누르면 공고 화면이 열립니다."
             " 출처가 '사이트' 인 건은 기관 홈페이지가 열립니다.\n"
             "A = 시가/대체 평가 및 채권평가회사(업종코드) 키워드 일치 · "
             "B = 키워드 일부 일치 · "
             "C = 기금/공제회 관련, 검토 필요 공고 (회색 줄)\n"
             "출처 — 나라장터: 나라장터에서 받은 공고 · "
             "나라장터+사이트(한 칸에 두 줄): 두 곳에 다 올라온 공고 · "
             "사이트: 기관 홈페이지에만 올라와 나라장터에는 없는 공고"
             " (마감일시·사업예산이 빈칸입니다)"),
